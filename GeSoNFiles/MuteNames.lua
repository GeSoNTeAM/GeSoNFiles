...
if DevAbs:get(GeSoN.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(GeSoN.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(GeSoN.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(GeSoN.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(GeSoN.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(GeSoN.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
GeSoNName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if GeSoNName then 
GeSoNNames = DevAbs:smembers(GeSoN.."Abs:Mute:Names"..msg.chat_id_) or ""
if GeSoNNames and GeSoNNames[1] then 
for i=1,#GeSoNNames do 
if GeSoNName:match("(.*)("..GeSoNNames[i]..")(.*)") then 
...
DevAbs:set(GeSoN.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(GeSoN.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
